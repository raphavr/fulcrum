...
digraph when_to_use {
    ...
    "Manual execution or /spec first" [shape=box];

    "Have implementation plan?" -> "Tasks mostly independent?" [label="yes"];
    "Have implementation plan?" -> "Manual execution or /spec first" [label="no"];
    "Tasks mostly independent?" -> "Stay in this session?" [label="yes"];
    "Tasks mostly independent?" -> "Manual execution or /spec first" [label="no - tightly coupled"];
...
digraph process {
    ...
    "Use fulcrum:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
...
- **fulcrum:requesting-code-review** - Code review template for reviewer subagents
- **fulcrum:finishing-a-development-branch** - Complete development after all tasks

**Subagents should use:**
- **fulcrum:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **fulcrum:executing-plans** - Use for parallel session instead of same-session execution
